--************************
--name		: SINGLE_CON_TS_02.lua
--ver		: 0.1f
--author	: Lupus
--date		: 2004/09/30
--lang		: fra
--desc		: terminal construction mission for second 5 Tsunami Construction items TL60,70,80,90,100
--npc		: 122, 125
--translation	: Legba
--************************
--changelog:
...
function DIALOG()
	...
	NODE(5)
		if(node==state)then
		GETTARGETVALUE(0,2)
			if(result==4375)then -- Item 1
				GIVEITEM(4562)
				GIVEITEM(4563)
				GIVEITEM(4569)
				GIVESPECIALITEM(1507,1,4375)
				SAY("Voilà les plans et les composants nécessaires.\nBonne chance.")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4376)then --Item 2
				GIVEITEM(4562)
				GIVEITEM(4563)
				GIVEITEM(4570)
				GIVESPECIALITEM(1507,1,4376)
				SAY("Très bien, voilà les plans et les composants.\nBonne chance!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4377)then --Item 3
				GIVEITEM(4562)
				GIVEITEM(4563)
				GIVEITEM(4571)
				GIVESPECIALITEM(1507,1,4377)
				SAY("Très bien, voilà les plans et les composants.\nBonne chance!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4378)then --Item 4
				GIVEITEM(4562)
				GIVEITEM(4563)
				GIVEITEM(4572)
				GIVESPECIALITEM(1507,1,4378)
				SAY("Très bien, voilà les plans et les composants.\nBonne chance!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4379)then --Item 5
				GIVEITEM(4562)
				GIVEITEM(4563)
				GIVEITEM(4573)
				GIVESPECIALITEM(1507,1,4379)
				SAY("Très bien, voilà les plans et les composants.\nBonne chance!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
