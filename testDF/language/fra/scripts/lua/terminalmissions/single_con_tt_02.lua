--************************
--name		: SINGLE_CON_TT_02.lua
--ver		: 0.1f
--author	: Lupus
--date		: 2004/09/30
--lang		: fra
--desc		: terminal construction mission for second 5 Tangent Construction items TL60,70,80,90,100
--npc		: 107, 106
--translation	: Legba
--************************
--changelog:
...
function DIALOG()
	...
	NODE(5)
		if(node==state)then
		GETTARGETVALUE(0,2)
			if(result==4330)then -- Item 1
				GIVEITEM(4511)
				GIVEITEM(4512)
				GIVEITEM(4518)
				GIVESPECIALITEM(1507,1,4330)
				SAY("Voilà les plans et les composants nécessaires.\nBonne chance.")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4331)then --Item 2
				GIVEITEM(4511)
				GIVEITEM(4512)
				GIVEITEM(4519)
				GIVESPECIALITEM(1507,1,4331)
				SAY("Très bien, voilà les plans et les composants.\nBonne chance!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4332)then --Item 3
				GIVEITEM(4511)
				GIVEITEM(4512)
				GIVEITEM(4520)
				GIVESPECIALITEM(1507,1,4332)
				SAY("Très bien, voilà les plans et les composants.\nBonne chance!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4333)then --Item 4
				GIVEITEM(4511)
				GIVEITEM(4512)
				GIVEITEM(4521)
				GIVESPECIALITEM(1507,1,4333)
				SAY("Très bien, voilà les plans et les composants.\nBonne chance!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4334)then --Item 5
				GIVEITEM(4511)
				GIVEITEM(4512)
				GIVEITEM(4522)
				GIVESPECIALITEM(1507,1,4334)
				SAY("Très bien, voilà les plans et les composants.\nBonne chance!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
