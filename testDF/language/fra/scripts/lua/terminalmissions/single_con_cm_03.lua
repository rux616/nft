--************************
--name		: SINGLE_CON_CM_03.lua
--ver		: 0.1f
--author	: Lupus
--date		: 2004/09/30
--lang		: fra
--desc		: terminal construction mission for last 5 City Merc Construction items TL110,120,130,140,150
--npc		: 190, 192
--translation	: Legba
--************************
--changelog:
...
function DIALOG()
	...
	NODE(5)
		if(node==state)then
		GETTARGETVALUE(0,2)
			if(result==4425)then -- Item 1
				GIVEITEM(4613)
				GIVEITEM(4614)
				GIVEITEM(4625)
				GIVESPECIALITEM(1507,1,4425)
				SAY("Voilà les plans et les composants nécessaires.\nBonne chance.")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4426)then --Item 2
				GIVEITEM(4613)
				GIVEITEM(4614)
				GIVEITEM(4626)
				GIVESPECIALITEM(1507,1,4426)
				SAY("Très bien, voilà les plans et les composants.\nBonne chance!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4427)then --Item 3
				GIVEITEM(4613)
				GIVEITEM(4614)
				GIVEITEM(4627)
				GIVESPECIALITEM(1507,1,4427)
				SAY("Très bien, voilà les plans et les composants.\nBonne chance!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4428)then --Item 4
				GIVEITEM(4613)
				GIVEITEM(4614)
				GIVEITEM(4628)
				GIVESPECIALITEM(1507,1,4428)
				SAY("Très bien, voilà les plans et les composants.\nBonne chance!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4429)then --Item 5
				GIVEITEM(4613)
				GIVEITEM(4614)
				GIVEITEM(4629)
				GIVESPECIALITEM(1507,1,4429)
				SAY("Très bien, voilà les plans et les composants.\nBonne chance!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
