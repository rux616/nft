--************************
--name		: SINGLE_CON_TT_01.lua
--ver		: 0.1f
--author	: Lupus
--date		: 2004/09/30
--lang		: fra
--desc		: terminal construction mission for first 5 Tangent Construction items TL10,20,30,40,50
--npc		: 107, 106
--translation	: Legba
--************************
--changelog:
...
function DIALOG()
	...
	NODE(5)
		if(node==state)then
		GETTARGETVALUE(0,2)
			if(result==4325)then -- Item 1
				GIVEITEM(4511)
				GIVEITEM(4512)
				GIVEITEM(4513)
				GIVESPECIALITEM(1507,1,4325)
				SAY("Voilà les plans et les composants nécessaires.\nBonne chance.")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4326)then --Item 2
				GIVEITEM(4511)
				GIVEITEM(4512)
				GIVEITEM(4514)
				GIVESPECIALITEM(1507,1,4326)
				SAY("Très bien, voilà les plans et les composants.\nBonne chance!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4327)then --Item 3
				GIVEITEM(4511)
				GIVEITEM(4512)
				GIVEITEM(4515)
				GIVESPECIALITEM(1507,1,4327)
				SAY("Très bien, voilà les plans et les composants.\nBonne chance!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4328)then --Item 4
				GIVEITEM(4511)
				GIVEITEM(4512)
				GIVEITEM(4516)
				GIVESPECIALITEM(1507,1,4328)
				SAY("Très bien, voilà les plans et les composants.\nBonne chance!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4329)then --Item 5
				GIVEITEM(4511)
				GIVEITEM(4512)
				GIVEITEM(4517)
				GIVESPECIALITEM(1507,1,4329)
				SAY("Très bien, voilà les plans et les composants.\nBonne chance!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
