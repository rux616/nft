--************************
--name		: SINGLE_CON_FA_02.lua
--ver		: 0.1f
--author	: Lupus
--date		: 2004/09/30
--lang		: fra
--desc		: terminal construction mission for second 5 Fallen Angels Construction items TL60,70,80,90,100
--npc		: 179, 178
--translation	: Legba
--************************
--changelog:
...
function DIALOG()
	...
	NODE(5)
		if(node==state)then
		GETTARGETVALUE(0,2)
			if(result==4435)then -- Item 1
				GIVEITEM(4630)
				GIVEITEM(4631)
				GIVEITEM(4637)
				GIVESPECIALITEM(1507,1,4435)
				SAY("Voilà les plans et les composants nécessaires.\nBonne chance.")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4436)then --Item 2
				GIVEITEM(4630)
				GIVEITEM(4631)
				GIVEITEM(4638)
				GIVESPECIALITEM(1507,1,4436)
				SAY("Très bien, voilà les plans et les composants.\nBonne chance!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4437)then --Item 3
				GIVEITEM(4630)
				GIVEITEM(4631)
				GIVEITEM(4639)
				GIVESPECIALITEM(1507,1,4437)
				SAY("Très bien, voilà les plans et les composants.\nBonne chance!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4438)then --Item 4
				GIVEITEM(4630)
				GIVEITEM(4631)
				GIVEITEM(4640)
				GIVESPECIALITEM(1507,1,4438)
				SAY("Très bien, voilà les plans et les composants.\nBonne chance!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4439)then --Item 5
				GIVEITEM(4630)
				GIVEITEM(4631)
				GIVEITEM(4641)
				GIVESPECIALITEM(1507,1,4439)
				SAY("Très bien, voilà les plans et les composants.\nBonne chance!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
