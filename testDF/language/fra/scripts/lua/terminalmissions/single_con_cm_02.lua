--************************
--name		: SINGLE_CON_CM_02.lua
--ver		: 0.1f
--author	: Lupus
--date		: 2004/09/30
--lang		: fra
--desc		: terminal construction mission for second 5 City Merc Construction items TL60,70,80,90,100
--npc		: 190, 192
--translation	: Legba
--************************
--changelog:
...
function DIALOG()
	...
	NODE(5)
		if(node==state)then
		GETTARGETVALUE(0,2)
			if(result==4420)then -- Item 1
				GIVEITEM(4613)
				GIVEITEM(4614)
				GIVEITEM(4620)
				GIVESPECIALITEM(1507,1,4420)
				SAY("Voilà les plans et les composants nécessaires.\nBonne chance.")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4421)then --Item 2
				GIVEITEM(4613)
				GIVEITEM(4614)
				GIVEITEM(4621)
				GIVESPECIALITEM(1507,1,4421)
				SAY("Très bien, voilà les plans et les composants.\nBonne chance!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4422)then --Item 3
				GIVEITEM(4613)
				GIVEITEM(4614)
				GIVEITEM(4622)
				GIVESPECIALITEM(1507,1,4422)
				SAY("Très bien, voilà les plans et les composants.\nBonne chance!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4423)then --Item 4
				GIVEITEM(4613)
				GIVEITEM(4614)
				GIVEITEM(4623)
				GIVESPECIALITEM(1507,1,4423)
				SAY("Très bien, voilà les plans et les composants.\nBonne chance!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4424)then --Item 5
				GIVEITEM(4613)
				GIVEITEM(4614)
				GIVEITEM(4624)
				GIVESPECIALITEM(1507,1,4424)
				SAY("Très bien, voilà les plans et les composants.\nBonne chance!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
