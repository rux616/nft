--************************
--name		: SINGLE_CON_PP_02.lua
--ver		: 0.1f
--author	: Lupus
--date		: 2004/09/30
--lang		: fra
--desc		: terminal construction mission for second 5 ProtoPharm Construction items TL60,70,80,90,100
--npc		: 52, 51
--translation	: Legba
--************************
--changelog:
...
function DIALOG()
	...
	NODE(5)
		if(node==state)then
		GETTARGETVALUE(0,2)
			if(result==4360)then -- Item 1
				GIVEITEM(4545)
				GIVEITEM(4546)
				GIVEITEM(4552)
				GIVESPECIALITEM(1507,1,4360)
				SAY("Voilà les plans et les composants nécessaires.\nBonne chance.")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4361)then --Item 2
				GIVEITEM(4545)
				GIVEITEM(4546)
				GIVEITEM(4553)
				GIVESPECIALITEM(1507,1,4361)
				SAY("Très bien, voilà les plans et les composants.\nBonne chance!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4362)then --Item 3
				GIVEITEM(4545)
				GIVEITEM(4546)
				GIVEITEM(4554)
				GIVESPECIALITEM(1507,1,4362)
				SAY("Très bien, voilà les plans et les composants.\nBonne chance!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4363)then --Item 4
				GIVEITEM(4545)
				GIVEITEM(4546)
				GIVEITEM(4555)
				GIVESPECIALITEM(1507,1,4363)
				SAY("Très bien, voilà les plans et les composants.\nBonne chance!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4364)then --Item 5
				GIVEITEM(4545)
				GIVEITEM(4546)
				GIVEITEM(4556)
				GIVESPECIALITEM(1507,1,4364)
				SAY("Très bien, voilà les plans et les composants.\nBonne chance!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
