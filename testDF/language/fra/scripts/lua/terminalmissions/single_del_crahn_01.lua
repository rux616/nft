function DIALOG()
	...
	NODE(1)
		GIVEQUESTITEM(91)
			SAY("Ah oui, c'est vrai, il faut que quelqu'un livre un petit quelque chose. Portez ceci à %NPC_NAME(1), à %NPC_WORLD(1), et dépêchez-vous. Lorsque vous avez fini, revenez ici et vous toucherez une récompense. Maintenant pressez le pas, disciple, au nom de Crahn !")
			SAY("Golon Kalah a besoin que ces documents parviennent rapidement à %NPC_NAME(1), à %NPC_WORLD(1). Une fois que cette livraison est effectuée, revenez ici et vous toucherez une récompense. Maintenant dépêchez-vous, %NPC_NAME(1) a grand besoin de ces documents.")
