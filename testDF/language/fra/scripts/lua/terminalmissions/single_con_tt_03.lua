--************************
--name		: SINGLE_CON_TT_03.lua
--ver		: 0.1f
--author	: Lupus
--date		: 2004/09/30
--lang		: fra
--desc		: terminal construction mission for last 5 Tangent Construction items TL110,120,130,140,150
--npc		: 107, 106
--translation	: Legba
--************************
--changelog:
...
function DIALOG()
	...
	NODE(5)
		if(node==state)then
		GETTARGETVALUE(0,2)
			if(result==4335)then -- Item 1
				GIVEITEM(4511)
				GIVEITEM(4512)
				GIVEITEM(4523)
				GIVESPECIALITEM(1507,1,4335)
				SAY("Voilà les plans et les composants nécessaires.\nBonne chance.")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4336)then --Item 2
				GIVEITEM(4511)
				GIVEITEM(4512)
				GIVEITEM(4524)
				GIVESPECIALITEM(1507,1,4336)
				SAY("Très bien, voilà les plans et les composants.\nBonne chance!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4337)then --Item 3
				GIVEITEM(4511)
				GIVEITEM(4512)
				GIVEITEM(4525)
				GIVESPECIALITEM(1507,1,4337)
				SAY("Très bien, voilà les plans et les composants.\nBonne chance!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4338)then --Item 4
				GIVEITEM(4511)
				GIVEITEM(4512)
				GIVEITEM(4526)
				GIVESPECIALITEM(1507,1,4338)
				SAY("Très bien, voilà les plans et les composants.\nBonne chance!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4339)then --Item 5
				GIVEITEM(4511)
				GIVEITEM(4512)
				GIVEITEM(4527)
				GIVESPECIALITEM(1507,1,4339)
				SAY("Très bien, voilà les plans et les composants.\nBonne chance!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
