...
function DIALOG()
	...
	NODE(1)
		...
		SAY("Runner, Tsunami has managed to dig up some interesting dirt on %NPC_NAME(1) at %NPC_WORLD(1). It has been summed up in this package and I want you to give it to them. Drop it off and run like a Titan was after you; they won't be happy when they open it.")
	...
	NODE(2)	
		ISMISSIONTARGETACCOMPLISHED(1)
			if (result==0) then
				...
				SAY("Hey-o. %NPC_NAME(1) called me up, so I guess you made the drop. %REWARD_MONEY() credits will be moved to your account. Tsunami thanks you for a job well done.")
				SAY("The drop has been confirmed and %REWARD_MONEY() credits have been moved to your account. Tsunami is grateful for your assistance. See you around.")
