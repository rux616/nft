--************************
--name		: SINGLE_CON_TG_02.lua
--ver		: 0.1f
--author	: Lupus
--date		: 2004/09/30
--lang		: fra
--desc		: terminal construction mission for second 5 Twilight Guardian Construction items TL60,70,80,90,100
--npc		: 205, 205
--translation	: Legba
--************************
--changelog:
...
function DIALOG()
	...
	NODE(5)
		if(node==state)then
		GETTARGETVALUE(0,2)
			if(result==4450)then -- Item 1
				GIVEITEM(4647)
				GIVEITEM(4648)
				GIVEITEM(4654)
				GIVESPECIALITEM(1507,1,4450)
				SAY("Voilà les plans et les composants nécessaires.\nBonne chance.")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4451)then --Item 2
				GIVEITEM(4647)
				GIVEITEM(4648)
				GIVEITEM(4655)
				GIVESPECIALITEM(1507,1,4451)
				SAY("Très bien, voilà les plans et les composants.\nBonne chance!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4452)then --Item 3
				GIVEITEM(4647)
				GIVEITEM(4648)
				GIVEITEM(4656)
				GIVESPECIALITEM(1507,1,4452)
				SAY("Très bien, voilà les plans et les composants.\nBonne chance!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4453)then --Item 4
				GIVEITEM(4647)
				GIVEITEM(4648)
				GIVEITEM(4657)
				GIVESPECIALITEM(1507,1,4453)
				SAY("Très bien, voilà les plans et les composants.\nBonne chance!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4454)then --Item 5
				GIVEITEM(4647)
				GIVEITEM(4648)
				GIVEITEM(4658)
				GIVESPECIALITEM(1507,1,4454)
				SAY("Très bien, voilà les plans et les composants.\nBonne chance!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
