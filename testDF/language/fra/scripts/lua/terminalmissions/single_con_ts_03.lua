--************************
--name		: SINGLE_CON_TS_03.lua
--ver		: 0.1f
--author	: Lupus
--date		: 2004/09/30
--lang		: fra
--desc		: terminal construction mission for last 5 Tsunami Construction items TL110,120,130,140,150
--npc		: 122, 125
--translation	: Legba
--************************
--changelog:
...
function DIALOG()
	...
	NODE(5)
		if(node==state)then
		GETTARGETVALUE(0,2)
			if(result==4380)then -- Item 1
				GIVEITEM(4562)
				GIVEITEM(4563)
				GIVEITEM(4574)
				GIVESPECIALITEM(1507,1,4380)
				SAY("Voilà les plans et les composants nécessaires.\nBonne chance.")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4381)then --Item 2
				GIVEITEM(4562)
				GIVEITEM(4563)
				GIVEITEM(4575)
				GIVESPECIALITEM(1507,1,4381)
				SAY("Très bien, voilà les plans et les composants.\nBonne chance!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4382)then --Item 3
				GIVEITEM(4562)
				GIVEITEM(4563)
				GIVEITEM(4576)
				GIVESPECIALITEM(1507,1,4382)
				SAY("Très bien, voilà les plans et les composants.\nBonne chance!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4383)then --Item 4
				GIVEITEM(4562)
				GIVEITEM(4563)
				GIVEITEM(4577)
				GIVESPECIALITEM(1507,1,4383)
				SAY("Très bien, voilà les plans et les composants.\nBonne chance!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4384)then --Item 5
				GIVEITEM(4562)
				GIVEITEM(4563)
				GIVEITEM(4578)
				GIVESPECIALITEM(1507,1,4384)
				SAY("Très bien, voilà les plans et les composants.\nBonne chance!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
