--************************
--name		: SINGLE_CON_PP_01.lua
--ver		: 0.1f
--author	: Lupus
--date		: 2004/09/30
--lang		: fra
--desc		: terminal construction mission for first 5 ProtoPharm Construction items TL10,20,30,40,50
--npc		: 52, 51
--translation	: Legba
--************************
--changelog:
...
function DIALOG()
	...
	NODE(5)
		if(node==state)then
		GETTARGETVALUE(0,2)
			if(result==4355)then -- Item 1
				GIVEITEM(4545)
				GIVEITEM(4546)
				GIVEITEM(4547)
				GIVESPECIALITEM(1507,1,4355)
				SAY("Voilà les plans et les composants nécessaires.\nBonne chance.")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4356)then --Item 2
				GIVEITEM(4545)
				GIVEITEM(4546)
				GIVEITEM(4548)
				GIVESPECIALITEM(1507,1,4356)
				SAY("Très bien, voilà les plans et les composants.\nBonne chance!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4357)then --Item 3
				GIVEITEM(4545)
				GIVEITEM(4546)
				GIVEITEM(4549)
				GIVESPECIALITEM(1507,1,4357)
				SAY("Très bien, voilà les plans et les composants.\nBonne chance!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4358)then --Item 4
				GIVEITEM(4545)
				GIVEITEM(4546)
				GIVEITEM(4550)
				GIVESPECIALITEM(1507,1,4358)
				SAY("Très bien, voilà les plans et les composants.\nBonne chance!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4359)then --Item 5
				GIVEITEM(4545)
				GIVEITEM(4546)
				GIVEITEM(4551)
				GIVESPECIALITEM(1507,1,4359)
				SAY("Très bien, voilà les plans et les composants.\nBonne chance!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
