	...
	NODE(3)
		ISMISSIONTARGETACCOMPLISHED(0)
			if (result==0) then  -- Mission is not accomplished
				...
				SAY("Runner, félicitations. Je pensais qu'on ne les aurait jamais... %REWARD_MONEY() crédits ont été transférés sur votre compte. ProtoPharm vous est reconnaissante pour votre aide. Si vous le désirez, d'autres missions sont disponibles sur votre terminal. Bonne journée.")	
