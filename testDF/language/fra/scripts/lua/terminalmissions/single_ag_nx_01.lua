...
function DIALOG()
	...
	NODE(2) -- Giving Mission
			SAY("We have a small extermination task for you. %TARGET_VALUE(0,1) %TARGET_NPCNAME(0) in the faction area are to be killed. Destroy them and return to me.")
			SAY("You look the part... we have a problem with %TARGET_NPCNAME(0) in the faction area. Exterminate %TARGET_VALUE(0,1) of them and come back here for your reward.")
			SAY("Runner, nice to see you. A gradual increase of %TARGET_NPCNAME(0) has been reported in the area over the last week or so. To protect our investments we need you to exterminate %TARGET_VALUE(0,1) of them. Return to me when you are done.")
	...
	NODE(3)
		ISMISSIONTARGETACCOMPLISHED(0)
			if (result==0) then  -- Mission is not accomplished
				...
				SAY("Runner, there are still a couple of them left. Go get them!")
				SAY("Back so soon? A message from Sukram, one of our techs in the area, says that there are still some %TARGET_NPCNAME(0) left. Go wipe them out.")
				SAY("I don't have time for this. Go destroy the %TARGET_NPCNAME(0) in the faction area, and make it quick.")
				ENDDIALOG()
				...
				SAY("Thank you for the help. %REWARD_MONEY() credits has been deposited into your acccount. Check your NEXT terminal for information on more jobs.")
				SAY("Runner, congratulations. The area looks clear, just a couple of blips on my terminal. %REWARD_MONEY() credits have been moved to your account. NEXT thanks you for the assistance, have a nice day.")	
