...
-- description single_as_01
	...
	NODE(2) -- Giving Mission
			...
			SAY("OK, voilà le dossier. Un de nos employés nous vole des drogues, beaucoup de drogues. Il s'agit de %NPC_NAME(1). Vous trouverez la cible dans %NPC_WORLD(1), et nous voulons que vous lui régliez son compte. Assurez-vous de faire quelque chose de sale, pour que les autres comprennent le message.")
			SAY("Ah, runner, c'est vous. Bien. Le problème s'appelle %NPC_NAME(1), vous le trouverez dans %NPC_WORLD(1). Une histoire de vol de produits pharmaceutiques. Nous voulons voir la cible morte, et bien morte. Revenez ensuite pour votre récompense.)
