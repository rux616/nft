...
fractionsayhello = "Nos armes, notre force."		-- Fraktionsansprache
fractionanswer = "Tangent est notre espoir"	-- Antwort darauf

-- factionfriends exitcodes:
lowloyalexit  = "Continuez comme ça!\nBonne journée"
midloyalexit  = "C'est toujours un plaisir de voir un fidèle employé de "..factionname.."."
highloyalexit = "Bon travail, nous aimons les vétérans qui ont fait leurs preuves."
...
function DIALOG()
	...
	NODE(200)
		...
		TAKEITEM(91)
		if (result==1) then
			SAY("Merci pour la livraison. Il y a peut-être d'autres missions disponibles auprès du responsable.") ;
