...
fractionsayhello = "La liberté de mouvement est un don."		-- Fraktionsansprache
fractionanswer = "Où que j'aille, je choisis NExT!"				-- Antwort darauf
...
function DIALOG()
	...
	NODE(200)
		...
		TAKEITEM(91)
		if (result==1) then
			SAY("Merci pour la livraison. Notre responsable en a sûrement une autre à vous proposer.") ;
