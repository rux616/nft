...
fractionsayhello = "Nous sommes l'évolution"		-- Fraktionsansprache
fractionanswer = "L'évolution sur mesure"		-- Antwort darauf
...
function DIALOG()
	...
	NODE(200)
		...
		TAKEITEM(91)
		if (result==1) then
			SAY("Merci pour la livraison. Au QG, ils auront certainement d'autres missions en réserve.") ;
