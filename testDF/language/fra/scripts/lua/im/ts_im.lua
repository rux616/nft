...
faction = 8 							
factionname = "Syndicat Tsunami"				

fractionsayhello = "Votre plaisir est notre affaire"		-- Fraktionsansprache
fractionanswer = "Et que l'argent coule à flots!"				-- Antwort darauf
...
function DIALOG()
	...
	NODE(200)
		...
		TAKEITEM(91)
		if (result==1) then
			SAY("Merci pour la livraison. Ils auront certainement autre chose à faire au QG maintenant.") ;
