...
faction = 15 							-- CA
factionname = "Gardiens du Crépuscule"				-- CA in text

fractionsayhello = "La liberté est notre loi!"		-- Fraktionsansprache
fractionanswer = "Et la paix notre but ultime!"		-- Antwort darauf
...
function DIALOG()
	...
	NODE(200)
		...
		TAKEITEM(91)
		if (result==1) then
			SAY("Merci pour la livraison. Notre responsable de propagande devrait pouvoir t'en confier une nouvelle.") ;
