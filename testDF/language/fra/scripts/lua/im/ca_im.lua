...
fractionsayhello = "Vive notre glorieux président Lioon Reza!"		-- Fraktionsansprache
fractionanswer = "Gloire à Reza!"				-- Antwort darauf
...
highloyalexit = "Reza est fier de vous. Il nous faut plus de vétérans dans votre genre."
