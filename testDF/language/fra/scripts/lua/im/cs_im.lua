...
faction = 10 							-- CA
factionname = "Secte Crahn"				-- CA in text

fractionsayhello = "Priez Crahn!"		-- Fraktionsansprache
fractionanswer = "*chante* Prions Crahn and his sons."				-- Antwort darauf
...
function DIALOG()
	...
	NODE(200)
		...
		TAKEITEM(91)
		if (result==1) then
			SAY("Merci pour la livraison. Retourne voir le moine qui te l'a commandée, tu en recevras certainement une autre.") ;
