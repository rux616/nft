...
faction = 14 							-- CA
factionname = "Anges Déchus"				-- CA in text

fractionsayhello = "Un esprit libre!"		-- Fraktionsansprache
fractionanswer = "Une société libre!"				-- Antwort darauf
...
function DIALOG()
	...
	-- neutral
	NODE(100) 
		SAY("Bienvenue dans le quartier général des "..factionname..".") ;
	...
	NODE(151) ;
		...
		ANSWER("Je suis nouveau chez les "..factionname..". J'ai besoin de prendre mes repères.",152) ;
	...
	NODE(200)
		...
		TAKEITEM(91)
		if (result==1) then
			SAY("Merci pour la livraison. Notre archiviste en aura certainement une autre à vous proposer.") ;
