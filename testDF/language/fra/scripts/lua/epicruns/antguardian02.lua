...
--50
	...
	NODE(51)
		SAY("C'est encore Top Secret. Et nous n'allons pas révéler ce dont il s'agit dans un futur proche. Mais nous avons découvert que Neocron est en possession de technologies qui pourront être utilisées comme source d'énergie pour nos projets.")
...
--DOY ID CUBE
		if(result==0)then
			...
			SAY("Aha, il y a du changement dans les envoyés du Dôme de Yorl à ce que je vois.")
	...
	NODE(102)
		SAY("CityAdmin méprise Crahn, Tsunami et le Dragon Noir encore plus qu'avant. Parfois, Reza entre même dans une colère noire à leur sujet. Me demandez pourquoi, j'en sais rien au juste.",103)
		
		ANSWER("Bien, alors donnez-moi ces infos et je m'en vais.",103)
	NODE(103)
		GIVEITEM(9433)
