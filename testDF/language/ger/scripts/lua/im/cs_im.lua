...
faction = 10 							-- CA
factionname = "Crahn Sect"				-- CA in text

fractionsayhello = "Preiset Crahn!"		-- Fraktionsansprache
fractionanswer = "*Chor* und all' seine Abkömmlinge."				-- Antwort darauf
...
function DIALOG()
	...
	NODE(200)
		...
		TAKEITEM(91)
		if (result==1) then
			SAY("Danke für das Paket. Du kannst Dich ruhig ein wenig umschauen. Wenn Du dann fertig bist gehe zurück zum Lore Keeper - er kann Dir noch einen anderen schnell zu erledigenden Auftrag geben.") ;
