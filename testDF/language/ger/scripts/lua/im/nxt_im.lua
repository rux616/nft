...
faction = 3 							-- CA
factionname = "N.E.X.T."				-- CA in text

fractionsayhello = "Wahre Bewegungsfreiheit."		-- Fraktionsansprache
fractionanswer = "Wohin ich auch fahre - Ich fahre mit NEXT"				-- Antwort darauf
