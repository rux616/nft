...
faction = 1 							-- CA
factionname = "City-Administration"				-- CA in text

fractionsayhello = "Gesegnet sei unser großer Direktor. Gesegnet sei Reza."		-- Fraktionsansprache
fractionanswer = "Gesegnet sei sein Schaffen!"				-- Antwort darauf
...
highloyalexit = "Reza is proud of you. We need more Veterans like you."
