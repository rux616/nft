...
faction = 14 							-- CA
factionname = "Fallen Angels"				-- CA in text

fractionsayhello = "Bewahre Dir einen freien Geist"		-- Fraktionsansprache
fractionanswer = "Forme eine freie Gesellschaft"				-- Antwort darauf
...
function DIALOG()
	...
	NODE(200)
		...
		TAKEITEM(91)
		if (result==1) then
			SAY("Danke für das Paket. Du kannst Dich ruhig ein wenig umschauen. Wenn Du dann fertig bist gehe zurück zum Knowledge Archivist - er kann Dir noch einen anderen schnell zu erledigenden Auftrag geben.") ;
