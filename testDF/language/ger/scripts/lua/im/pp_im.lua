...
faction = 6 							-- CA
factionname = "ProtoPharm"				-- CA in text

fractionsayhello = "Wir erleuchten Dein Leben"		-- Fraktionsansprache
fractionanswer = "Unsere Hoffnungen, unsere Stärke, unsere Behandlung"		-- Antwort darauf
