...
fractionsayhello = "Deine Sicherheit liegt uns am Herzen."		-- Fraktionsansprache
fractionanswer = "Aber wir können nicht dafür garantieren, wenn Du nicht bezahlst. *g*"				-- Antwort darauf
...
function DIALOG()
	...
	NODE(200)
		...
		TAKEITEM(91)
		if (result==1) then
			SAY("Danke für das Paket. Du kannst Dich ruhig ein wenig umschauen. Wenn Du dann fertig bist gehe zurück zum Info Guy - er kann Dir noch einen anderen schnell zu erledigenden Auftrag geben.") ;
