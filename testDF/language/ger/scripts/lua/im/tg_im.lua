...
faction = 15 							-- CA
factionname = "Twilight Guardian"				-- CA in text

fractionsayhello = "Freiheit ist unser Gesetz"		-- Fraktionsansprache
fractionanswer = "Unser Wunsch ist Friede"		-- Antwort darauf
...
function DIALOG()
	...
	NODE(200)
		...
		TAKEITEM(91)
		if (result==1) then
			SAY("Danke für das Paket. Du kannst Dich ruhig ein wenig umschauen. Wenn Du dann fertig bist gehe zurück zum Propaganda Officer - er kann Dir noch einen anderen schnell zu erledigenden Auftrag geben.") ;
