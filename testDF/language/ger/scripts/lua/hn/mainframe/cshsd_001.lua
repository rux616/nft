...
--** Brotherhood of Crahn High Security Database  **
--** cshsd_001				          **
--**************************************************
...
DBNAME="Brotherhood of Crahn High Security Database"
FACNAME="Brotherhood of Crahn"
FACSLOGAN="The faith, the will, the way"
CODEBREAKERID=11950
...
-- GRP2 Aggressive PSI Modules -  20 slots frei"
DESC41="Crahn Holy Antibuff"            
SLOT41=597                                       
DESC42="Crahn Holy Pestilence"         
SLOT42=1207
--DESC43=
--SLOT43=
--DESC44=
...
-- GRP 3 Passive PSI Modules -  20 slots frei
--DESC61=
--SLOT61=
--DESC62=
--SLOT62=
...
NODE(0)
	...
	if (result == 1) then
		...
		TAKEITEM(CODEBREAKERID)
			if (result==1) then 
			SAY(""..CODEBREAKER.." loaded ...... Decryption process initiated ...... Decryption process successfull ......")
			ANSWER("       - Continue",5)
			else
				GETRELATION()
				if (result==3) then
...
NODE(210)
	...
	if (result==1) then
		...
		GIVESPECIALITEM(11990,1,ITEMSLOT)
		ANSWER("       Download complete.",0)
	else
