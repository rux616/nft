...
function DIALOG()
	...
	NODE(0)
	  if (node == state) then
		...
		if (result == 1) then
			...
			if (result >= 40) then 
				SAY("Hallo und Willkommen. Ich habe die Ressourcen die Du brauchst.")
	...
	NODE(1)
		SAY("Ich handle mit Versorgungsgütern und Einzelteilen zum Bau verschiedener Gegenstände. Du kannst sie im Shop kaufen oder bei einem Conster der sie selbst erstellt.")
