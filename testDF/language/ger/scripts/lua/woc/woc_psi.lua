...
function DIALOG()
	...
	NODE(0) 
		...
		ANSWER("Ich suche das vergessen geglaubte Wissen von Ceres.",10)
		...
		if (WOC_SKILL~=result) and (result~=0) then
			...
			if (result==0) then
				...
				if (result~=-2) then
					...
					SAY("YDu erfüllst nicht die Voraussetzungen, um das Wissen von Ceres zu erwerben. Du musst den Epic Run deiner Fraktion erledigen, bevor ich Dich unterrichten kann! Komme wieder, wenn Du bereit bist, diese große Ehre zu empfangen.") 
					ENDDIALOG()
				else
