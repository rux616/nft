--************************
--name		: SINGLE_CON_CS_03.lua
--ver		: 0.1g
--author	: Lupus
--date		: 2004/09/30
--lang		: de
--desc		: terminal construction mission for last 5 Crahn Sect Construction items TL110,120,130,140,150
--npc		: 142, 140
--translation	: Ferron
--************************
--changelog:
...
function DIALOG()
	...
	NODE(5)
		if(node==state)then
		GETTARGETVALUE(0,2)
			if(result==4410)then -- Item 1
				GIVEITEM(4596)
				GIVEITEM(4597)
				GIVEITEM(4608)
				GIVESPECIALITEM(1507,1,4410)
				SAY("Sehr gut, hier ist das Blueprint und die Parts die du brauchst um den Job zu machen.\nViel Glück!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4411)then --Item 2
				GIVEITEM(4596)
				GIVEITEM(4597)
				GIVEITEM(4609)
				GIVESPECIALITEM(1507,1,4411)
				SAY("Sehr gut, hier ist das Blueprint und die Parts die du brauchst um den Job zu machen.\nViel Glück!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4412)then --Item 3
				GIVEITEM(4596)
				GIVEITEM(4597)
				GIVEITEM(4610)
				GIVESPECIALITEM(1507,1,4412)
				SAY("Sehr gut, hier ist das Blueprint und die Parts die du brauchst um den Job zu machen.\nViel Glück!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4413)then --Item 4
				GIVEITEM(4596)
				GIVEITEM(4597)
				GIVEITEM(4611)
				GIVESPECIALITEM(1507,1,4413)
				SAY("Sehr gut, hier ist das Blueprint und die Parts die du brauchst um den Job zu machen.\nViel Glück!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4414)then --Item 5
				GIVEITEM(4596)
				GIVEITEM(4597)
				GIVEITEM(4612)
				GIVESPECIALITEM(1507,1,4414)
				SAY("Sehr gut, hier ist das Blueprint und die Parts die du brauchst um den Job zu machen.\nViel Glück!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
