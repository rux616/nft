--************************
--name		: SINGLE_CON_FA_03.lua
--ver		: 0.1g
--author	: Lupus
--date		: 2004/09/30
--lang		: de
--desc		: terminal construction mission for last 5 Fallen Angels Construction items TL110,120,130,140,150
--npc		: 179, 178
--translation	: Ferron
--************************
--changelog:
...
function DIALOG()
	...
	NODE(5)
		if(node==state)then
		GETTARGETVALUE(0,2)
			if(result==4440)then -- Item 1
				GIVEITEM(4630)
				GIVEITEM(4631)
				GIVEITEM(4642)
				GIVESPECIALITEM(1507,1,4440)
				SAY("Sehr gut, hier ist das Blueprint und die Parts die du brauchst um den Job zu machen.\nViel Glück!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4441)then --Item 2
				GIVEITEM(4630)
				GIVEITEM(4631)
				GIVEITEM(4643)
				GIVESPECIALITEM(1507,1,4441)
				SAY("Sehr gut, hier ist das Blueprint und die Parts die du brauchst um den Job zu machen.\nViel Glück!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4442)then --Item 3
				GIVEITEM(4630)
				GIVEITEM(4631)
				GIVEITEM(4644)
				GIVESPECIALITEM(1507,1,4442)
				SAY("Sehr gut, hier ist das Blueprint und die Parts die du brauchst um den Job zu machen.\nViel Glück!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4443)then --Item 4
				GIVEITEM(4630)
				GIVEITEM(4631)
				GIVEITEM(4645)
				GIVESPECIALITEM(1507,1,4443)
				SAY("Sehr gut, hier ist das Blueprint und die Parts die du brauchst um den Job zu machen.\nViel Glück!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4444)then --Item 5
				GIVEITEM(4630)
				GIVEITEM(4631)
				GIVEITEM(4646)
				GIVESPECIALITEM(1507,1,4444)
				SAY("Sehr gut, hier ist das Blueprint und die Parts die du brauchst um den Job zu machen.\nViel Glück!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
