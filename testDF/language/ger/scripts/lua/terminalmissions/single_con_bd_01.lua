--************************
--name		: SINGLE_CON_BD_01.lua
--ver		: 0.1g
--author	: Lupus
--date		: 2004/09/30
--lang		: de
--desc		: terminal construction mission for first 5 Black Dragon Construction items TL10,20,30,40,50
--npc		: 132, 131
--translation	: Ferron
--************************
--changelog:
...
function DIALOG()
	...
	NODE(5)
		if(node==state)then
		GETTARGETVALUE(0,2)
			if(result==4385)then -- Item 1
				GIVEITEM(4579)
				GIVEITEM(4580)
				GIVEITEM(4581)
				GIVESPECIALITEM(1507,1,4385)
				SAY("Sehr gut, hier ist das Blueprint und die Parts die du brauchst um den Job zu machen.\nViel Glück!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4386)then --Item 2
				GIVEITEM(4579)
				GIVEITEM(4580)
				GIVEITEM(4582)
				GIVESPECIALITEM(1507,1,4386)
				SAY("Sehr gut, hier ist das Blueprint und die Parts die du brauchst um den Job zu machen.\nViel Glück!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4387)then --Item 3
				GIVEITEM(4579)
				GIVEITEM(4580)
				GIVEITEM(4583)
				GIVESPECIALITEM(1507,1,4387)
				SAY("Sehr gut, hier ist das Blueprint und die Parts die du brauchst um den Job zu machen.\nViel Glück!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4388)then --Item 4
				GIVEITEM(4579)
				GIVEITEM(4580)
				GIVEITEM(4584)
				GIVESPECIALITEM(1507,1,4388)
				SAY("Sehr gut, hier ist das Blueprint und die Parts die du brauchst um den Job zu machen.\nViel Glück!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4389)then --Item 5
				GIVEITEM(4579)
				GIVEITEM(4580)
				GIVEITEM(4585)
				GIVESPECIALITEM(1507,1,4389)
				SAY("Sehr gut, hier ist das Blueprint und die Parts die du brauchst um den Job zu machen.\nViel Glück!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
