...
function DIALOG()
	...
	NODE(1)
		...
		SAY("Runner, Tsunami hat ein paar schmutzige Sachen ueber %NPC_NAME(1) in %NPC_WORLD(1) in Erfahrung bringen koennen. Der Inhalt dieses Paketes, dass Sie ihm geben sollen, wird ihm nicht gefallen. Liefern Sie es ab und dann verschwinden Sie da, so schnell Sie koennen. Er wird bestimmt nicht sehr erfreut sein.")
	...
	NODE(2)	
		ISMISSIONTARGETACCOMPLISHED(1)
			if (result==0) then
				...
				SAY("Hey-o. %NPC_NAME(1) rief mich an, also nehme ich mal an, dass das Paket angekommen ist. %REWARD_MONEY() Credits werden Ihrem Konto gutgeschrieben. Tsunami dankt Ihnen fuer die gute Arbeit.")
				SAY("Die Lieferung wurde bestaetigt und Ihre Bezahlung von %REWARD_MONEY() Credits auf Ihr Konto ueberwiesen. Tsunami ist Ihnen fuer die Unterstützung dankbar. Man sieht sich.")
