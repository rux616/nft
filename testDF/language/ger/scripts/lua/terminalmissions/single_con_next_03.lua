--************************
--name		: SINGLE_CON_NEXT_03.lua
--ver		: 0.1g
--author	: Lupus
--date		: 2004/09/30
--lang		: de
--desc		: terminal construction mission for last 5 NEXT Construction items TL110,120,130,140,150
--npc		: 42, 43
--translation	: Ferron
--************************
--changelog:
...
function DIALOG()
	...
	NODE(5)
		if(node==state)then
		GETTARGETVALUE(0,2)
			if(result==4320)then -- Item 1
				GIVEITEM(4494)
				GIVEITEM(4495)
				GIVEITEM(4506)
				GIVESPECIALITEM(1507,1,4320)
				SAY("Sehr gut, hier ist das Blueprint und die Parts die du brauchst um den Job zu machen.\nViel Glück!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4321)then --Item 2
				GIVEITEM(4494)
				GIVEITEM(4495)
				GIVEITEM(4507)
				GIVESPECIALITEM(1507,1,4321)
				SAY("Sehr gut, hier ist das Blueprint und die Parts die du brauchst um den Job zu machen.\nViel Glück!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4322)then --Item 3
				GIVEITEM(4494)
				GIVEITEM(4495)
				GIVEITEM(4508)
				GIVESPECIALITEM(1507,1,4322)
				SAY("Sehr gut, hier ist das Blueprint und die Parts die du brauchst um den Job zu machen.\nViel Glück!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4323)then --Item 4
				GIVEITEM(4494)
				GIVEITEM(4495)
				GIVEITEM(4509)
				GIVESPECIALITEM(1507,1,4323)
				SAY("Sehr gut, hier ist das Blueprint und die Parts die du brauchst um den Job zu machen.\nViel Glück!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4324)then --Item 5
				GIVEITEM(4494)
				GIVEITEM(4495)
				GIVEITEM(4510)
				GIVESPECIALITEM(1507,1,4324)
				SAY("Sehr gut, hier ist das Blueprint und die Parts die du brauchst um den Job zu machen.\nViel Glück!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
