--************************
--name		: SINGLE_CON_FA_01.lua
--ver		: 0.1g
--author	: Lupus
--date		: 2004/09/30
--lang		: de
--desc		: terminal construction mission for first 5 Fallen Angels Construction items TL10,20,30,40,50
--npc		: 179, 178
--translation	: Ferron
--************************
--changelog:
...
function DIALOG()
	...
	NODE(5)
		if(node==state)then
		GETTARGETVALUE(0,2)
			if(result==4430)then -- Item 1
				GIVEITEM(4630)
				GIVEITEM(4631)
				GIVEITEM(4632)
				GIVESPECIALITEM(1507,1,4430)
				SAY("Sehr gut, hier ist das Blueprint und die Parts die du brauchst um den Job zu machen.\nViel Glück!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4431)then --Item 2
				GIVEITEM(4630)
				GIVEITEM(4631)
				GIVEITEM(4633)
				GIVESPECIALITEM(1507,1,4431)
				SAY("Sehr gut, hier ist das Blueprint und die Parts die du brauchst um den Job zu machen.\nViel Glück!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4432)then --Item 3
				GIVEITEM(4630)
				GIVEITEM(4631)
				GIVEITEM(4634)
				GIVESPECIALITEM(1507,1,4432)
				SAY("Sehr gut, hier ist das Blueprint und die Parts die du brauchst um den Job zu machen.\nViel Glück!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4433)then --Item 4
				GIVEITEM(4630)
				GIVEITEM(4631)
				GIVEITEM(4635)
				GIVESPECIALITEM(1507,1,4433)
				SAY("Sehr gut, hier ist das Blueprint und die Parts die du brauchst um den Job zu machen.\nViel Glück!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4434)then --Item 5
				GIVEITEM(4630)
				GIVEITEM(4631)
				GIVEITEM(4636)
				GIVESPECIALITEM(1507,1,4434)
				SAY("Sehr gut, hier ist das Blueprint und die Parts die du brauchst um den Job zu machen.\nViel Glück!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
