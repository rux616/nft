--************************
--name		: SINGLE_CON_NEXT_02.lua
--ver		: 0.1g
--author	: Lupus
--date		: 2004/09/30
--lang		: de
--desc		: terminal construction mission for second 5 NEXT Construction items TL60,70,80,90,100
--npc		: 42, 41
--translation	: Ferron
--************************
--changelog:
...
function DIALOG()
	...
	NODE(5)
		if(node==state)then
		GETTARGETVALUE(0,2)
			if(result==4315)then -- Item 1
				GIVEITEM(4494)
				GIVEITEM(4495)
				GIVEITEM(4501)
				GIVESPECIALITEM(1507,1,4315)
				SAY("Sehr gut, hier ist das Blueprint und die Parts die du brauchst um den Job zu machen.\nViel Glück!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4316)then --Item 2
				GIVEITEM(4494)
				GIVEITEM(4495)
				GIVEITEM(4502)
				GIVESPECIALITEM(1507,1,4316)
				SAY("Sehr gut, hier ist das Blueprint und die Parts die du brauchst um den Job zu machen.\nViel Glück!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4317)then --Item 3
				GIVEITEM(4494)
				GIVEITEM(4495)
				GIVEITEM(4503)
				GIVESPECIALITEM(1507,1,4317)
				SAY("Sehr gut, hier ist das Blueprint und die Parts die du brauchst um den Job zu machen.\nViel Glück!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4318)then --Item 4
				GIVEITEM(4494)
				GIVEITEM(4495)
				GIVEITEM(4504)
				GIVESPECIALITEM(1507,1,4318)
				SAY("Sehr gut, hier ist das Blueprint und die Parts die du brauchst um den Job zu machen.\nViel Glück!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4319)then --Item 5
				GIVEITEM(4494)
				GIVEITEM(4495)
				GIVEITEM(4505)
				GIVESPECIALITEM(1507,1,4319)
				SAY("Sehr gut, hier ist das Blueprint und die Parts die du brauchst um den Job zu machen.\nViel Glück!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
