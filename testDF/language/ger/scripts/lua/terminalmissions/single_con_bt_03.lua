--************************
--name		: SINGLE_CON_BT_03.lua
--ver		: 0.1g
--author	: Lupus
--date		: 2004/09/30
--lang		: de
--desc		: terminal construction mission for last 5 BioTech Construction items TL110,120,130,140,150
--npc		: 112, 111
--translation	: Ferron
--************************
--changelog:
...
function DIALOG()
	...
	NODE(5)
		if(node==state)then
		GETTARGETVALUE(0,2)
			if(result==4350)then -- Item 1
				GIVEITEM(4528)
				GIVEITEM(4529)
				GIVEITEM(4540)
				GIVESPECIALITEM(1507,1,4350)
				SAY("Sehr gut, hier ist das Blueprint und die Parts die du brauchst um den Job zu machen.\nViel Glück!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4351)then --Item 2
				GIVEITEM(4528)
				GIVEITEM(4529)
				GIVEITEM(4541)
				GIVESPECIALITEM(1507,1,4351)
				SAY("Sehr gut, hier ist das Blueprint und die Parts die du brauchst um den Job zu machen.\nViel Glück!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4352)then --Item 3
				GIVEITEM(4528)
				GIVEITEM(4529)
				GIVEITEM(4542)
				GIVESPECIALITEM(1507,1,4352)
				SAY("Sehr gut, hier ist das Blueprint und die Parts die du brauchst um den Job zu machen.\nViel Glück!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4353)then --Item 4
				GIVEITEM(4528)
				GIVEITEM(4529)
				GIVEITEM(4543)
				GIVESPECIALITEM(1507,1,4353)
				SAY("Sehr gut, hier ist das Blueprint und die Parts die du brauchst um den Job zu machen.\nViel Glück!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4354)then --Item 5
				GIVEITEM(4528)
				GIVEITEM(4529)
				GIVEITEM(4544)
				GIVESPECIALITEM(1507,1,4354)
				SAY("Sehr gut, hier ist das Blueprint und die Parts die du brauchst um den Job zu machen.\nViel Glück!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
