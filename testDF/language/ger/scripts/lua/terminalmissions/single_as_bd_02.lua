...
function DIALOG()
	...
	NODE(2) -- Giving Mission
			SAY("Es gibt da diesen... Konkurrenten %NPC_NAME(1), der dringend von einem Killer besucht werden muesste. Er haelt sich meistens in %NPC_WORLD(1) auf. Wir von BlackDragon wuerden es sehr schaetzen, wenn Du diese Sache in die Hand nehmen koenntest. Stelle sicher, dass das Ziel auch wirklich erledigt ist und komm dann wieder her.")
