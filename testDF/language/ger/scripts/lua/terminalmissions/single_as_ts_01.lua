...
function DIALOG()
	...
	NODE(2) -- Giving Mission
			...
			SAY("Runner, Tsunami braucht Deine Hilfe bei der Beseitigung eines Typen mit Namen %NPC_NAME(1). Der Bastard haelt sich wahrscheinlich in %NPC_WORLD(1) auf. Finde ihn und mach ihn richtig fertig. Danach kommst Du wieder zu mir.")
