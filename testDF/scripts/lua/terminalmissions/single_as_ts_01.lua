...
function DIALOG()
	...
	NODE(2) -- Giving Mission
			...
			SAY("Runner, Tsunami needs your help in the neutralization of a jingo named %NPC_NAME(1). Look for the bastisch in %NPC_WORLD(1) and burn the coward real proper like. Then return to me.")
	...
	NODE(3)
		ISMISSIONTARGETACCOMPLISHED(0)
			if (result==0) then  -- Mission is not accomplished
				...
				SAY("Hey-o, Runner. %NPC_NAME(1) is no more and Tsunami is most grateful for your work. %REWARD_MONEY() credits will be moved to your account. Our pleasure doing business with you.")	
