...
function DIALOG()
	...
	NODE(2) -- Giving Mission
			SAY("There is this...competitor, named %NPC_NAME(1) that needs an urgent visit by a hit-man. The targat can usually be found in %NPC_WORLD(1). We here at Tsunami would like it very much if you dealt with this matter. Make sure the target has flatlined and then come back here.")
			...
			SAY("Runner, Tsunami needs your help with the neutralization of a certain %NPC_NAME(1) in %NPC_WORLD(1). Deal with it, make it publicly and then return to me.")
	...
	NODE(3)
		ISMISSIONTARGETACCOMPLISHED(0)
			if (result==0) then  -- Mission is not accomplished
				...
				SAY("Samurai, they say you neutralized %NPC_NAME(1) like I told you. They say you did a good job. The %REWARD_MONEY() credits will be moved to your acccount. Tsunami thanks you for your gratious assistance.")
