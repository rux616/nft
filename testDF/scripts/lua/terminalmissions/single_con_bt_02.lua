--************************
--name		: SINGLE_CON_BT_02.lua
--ver		: 0.1e
--author	: Lupus
--date		: 2004/09/30
--lang		: en
--desc		: terminal construction mission for second 5 BioTech Construction items TL60,70,80,90,100
--npc		: 112, 111
--************************
--changelog:
...
function DIALOG()
	...
	NODE(5)
		if(node==state)then
		GETTARGETVALUE(0,2)
			if(result==4345)then -- Item 1
				GIVEITEM(4528)
				GIVEITEM(4529)
				GIVEITEM(4535)
				GIVESPECIALITEM(1507,1,4345)
				SAY("Very well, Here is the blueprint and the parts you will need to complete the job.\nGood luck!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4346)then --Item 2
				GIVEITEM(4528)
				GIVEITEM(4529)
				GIVEITEM(4536)
				GIVESPECIALITEM(1507,1,4346)
				SAY("Very well, Here is the blueprint and the parts you will need to complete the job.\nGood luck!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4347)then --Item 3
				GIVEITEM(4528)
				GIVEITEM(4529)
				GIVEITEM(4537)
				GIVESPECIALITEM(1507,1,4347)
				SAY("Very well, Here is the blueprint and the parts you will need to complete the job.\nGood luck!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4348)then --Item 4
				GIVEITEM(4528)
				GIVEITEM(4529)
				GIVEITEM(4538)
				GIVESPECIALITEM(1507,1,4348)
				SAY("Very well, Here is the blueprint and the parts you will need to complete the job.\nGood luck!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4349)then --Item 5
				GIVEITEM(4528)
				GIVEITEM(4529)
				GIVEITEM(4539)
				GIVESPECIALITEM(1507,1,4349)
				SAY("Very well, Here is the blueprint and the parts you will need to complete the job.\nGood luck!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
