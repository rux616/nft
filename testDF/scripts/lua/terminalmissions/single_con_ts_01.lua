--************************
--name		: SINGLE_CON_TS_01.lua
--ver		: 0.1e
--author	: Lupus
--date		: 2004/09/30
--lang		: en
--desc		: terminal construction mission for first 5 Tsunami Construction items TL10,20,30,40,50
--npc		: 122, 125
--************************
--changelog:
...
function DIALOG()
	...
	NODE(5)
		if(node==state)then
		GETTARGETVALUE(0,2)
			if(result==4370)then -- Item 1
				GIVEITEM(4562)
				GIVEITEM(4563)
				GIVEITEM(4564)
				GIVESPECIALITEM(1507,1,4370)
				SAY("Very well, Here is the blueprint and the parts you will need to complete the job.\nGood luck!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4371)then --Item 2
				GIVEITEM(4562)
				GIVEITEM(4563)
				GIVEITEM(4565)
				GIVESPECIALITEM(1507,1,4371)
				SAY("Very well, Here is the blueprint and the parts you will need to complete the job.\nGood luck!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4372)then --Item 3
				GIVEITEM(4562)
				GIVEITEM(4563)
				GIVEITEM(4566)
				GIVESPECIALITEM(1507,1,4372)
				SAY("Very well, Here is the blueprint and the parts you will need to complete the job.\nGood luck!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4373)then --Item 4
				GIVEITEM(4562)
				GIVEITEM(4563)
				GIVEITEM(4567)
				GIVESPECIALITEM(1507,1,4373)
				SAY("Very well, Here is the blueprint and the parts you will need to complete the job.\nGood luck!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4374)then --Item 5
				GIVEITEM(4562)
				GIVEITEM(4563)
				GIVEITEM(4568)
				GIVESPECIALITEM(1507,1,4374)
				SAY("Very well, Here is the blueprint and the parts you will need to complete the job.\nGood luck!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
