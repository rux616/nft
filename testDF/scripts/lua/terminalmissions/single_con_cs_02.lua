--************************
--name		: SINGLE_CON_CS_02.lua
--ver		: 0.1e
--author	: Lupus
--date		: 2004/09/30
--lang		: en
--desc		: terminal construction mission for second 5 Crahn Sect Construction items TL60,70,80,90,100
--npc		: 142, 140
--************************
--changelog:
...
function DIALOG()
	...
	NODE(5)
		if(node==state)then
		GETTARGETVALUE(0,2)
			if(result==4405)then -- Item 1
				GIVEITEM(4596)
				GIVEITEM(4597)
				GIVEITEM(4603)
				GIVESPECIALITEM(1507,1,4405)
				SAY("Very well, Here is the blueprint and the parts you will need to complete the job.\nGood luck!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4406)then --Item 2
				GIVEITEM(4596)
				GIVEITEM(4597)
				GIVEITEM(4604)
				GIVESPECIALITEM(1507,1,4406)
				SAY("Very well, Here is the blueprint and the parts you will need to complete the job.\nGood luck!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4407)then --Item 3
				GIVEITEM(4596)
				GIVEITEM(4597)
				GIVEITEM(4605)
				GIVESPECIALITEM(1507,1,4407)
				SAY("Very well, Here is the blueprint and the parts you will need to complete the job.\nGood luck!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4408)then --Item 4
				GIVEITEM(4596)
				GIVEITEM(4597)
				GIVEITEM(4606)
				GIVESPECIALITEM(1507,1,4408)
				SAY("Very well, Here is the blueprint and the parts you will need to complete the job.\nGood luck!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4409)then --Item 5
				GIVEITEM(4596)
				GIVEITEM(4597)
				GIVEITEM(4607)
				GIVESPECIALITEM(1507,1,4409)
				SAY("Very well, Here is the blueprint and the parts you will need to complete the job.\nGood luck!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
