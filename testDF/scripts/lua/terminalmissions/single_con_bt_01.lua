--************************
--name		: SINGLE_CON_BT_01.lua
--ver		: 0.1e
--author	: Lupus
--date		: 2004/09/30
--lang		: en
--desc		: terminal construction mission for first 5 BioTech Construction items TL10,20,30,40,50
--npc		: 112, 111
--************************
--changelog:
...
function DIALOG()
	...
	NODE(5)
		if(node==state)then
		GETTARGETVALUE(0,2)
			if(result==4340)then -- Item 1
				GIVEITEM(4528)
				GIVEITEM(4529)
				GIVEITEM(4530)
				GIVESPECIALITEM(1507,1,4340)
				SAY("Very well, Here is the blueprint and the parts you will need to complete the job.\nGood luck!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4341)then --Item 2
				GIVEITEM(4528)
				GIVEITEM(4529)
				GIVEITEM(4531)
				GIVESPECIALITEM(1507,1,4341)
				SAY("Very well, Here is the blueprint and the parts you will need to complete the job.\nGood luck!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4342)then --Item 3
				GIVEITEM(4528)
				GIVEITEM(4529)
				GIVEITEM(4532)
				GIVESPECIALITEM(1507,1,4342)
				SAY("Very well, Here is the blueprint and the parts you will need to complete the job.\nGood luck!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4343)then --Item 4
				GIVEITEM(4528)
				GIVEITEM(4529)
				GIVEITEM(4533)
				GIVESPECIALITEM(1507,1,4343)
				SAY("Very well, Here is the blueprint and the parts you will need to complete the job.\nGood luck!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
			elseif(result==4344)then --Item 5
				GIVEITEM(4528)
				GIVEITEM(4529)
				GIVEITEM(4534)
				GIVESPECIALITEM(1507,1,4344)
				SAY("Very well, Here is the blueprint and the parts you will need to complete the job.\nGood luck!")
				ACTIVATEDIALOGTRIGGER(0)
				SETNEXTDIALOGSTATE(3)
				ENDDIALOG()
