...
function DIALOG()
	...
	NODE(0)
	  if (node == state) then
		...
		if (result == 1) then
			...
			if (result >= 40) then 
				SAY("Hello and welcome.I have the ressources you need.")
	...
	NODE(1)
		SAY("I trade supplys and parts for building things. You can buy things in a store or from constructors who build them on their own.")
