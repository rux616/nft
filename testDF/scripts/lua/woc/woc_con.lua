...
function DIALOG()
	...
	NODE(10)
		...
		if (WOC_SKILL~=result) and (result~=0) then
			...
			SAY("My senses are telling me that you are not seeking the Wisdom of Ceres "..SKILLNAME(result)..". Talk to the other Savants. They may assist you with your needs.")
			ENDDIALOG()
		else
			if (result==0) then
				...
				if (result~=-2) then
					...
					SAY("What is your covet, stranger?")
					ANSWER("I want to recieve my Wisdom of Ceres "..SKILLNAME(result).." skill. Can you train me, honorable Savant?",20)
				end
			else
